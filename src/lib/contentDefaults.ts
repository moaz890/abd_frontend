...
export const DEFAULT_SITE_CONTENT: SiteContent = {
  ...
  leadFormSection: {
    badge:    '📋 نموذج الأهلية',
    title:    'تحقق من أهليتك في دقيقتين',
    subtitle:
      'أدخل بياناتك وسيتواصل معك فريقنا خلال 24 ساعة لتأكيد عرضك المخصص.',
    consentText:
      'بالضغط على «تحقق من أهليتي» أوافق على أن يتواصل معي فريق ABD — اي بي دي لعرض الخدمات المناسبة لي.',
  },
